...
sh testing.sh 1-Single-Uni-Data 1src-out.temp 1rcv-out.temp test-1-single-universe-data/test1_src test-1-single-universe-data/test1_rcv test-1-single-universe-data/src_expected test-1-single-universe-data/rcv_expected 2
...
sh testing.sh 4-Overflow-Sequence 4src-out.temp 4rcv-out.temp test-4-single-universe-data-overflow-sequence/src test-4-single-universe-data-overflow-sequence/rcv test-4-single-universe-data-overflow-sequence/src_expected test-4-single-universe-data-overflow-sequence/rcv_expected 10
