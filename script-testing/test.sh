...
sh test_run.sh 5-terminate-universe-discovery-check 5src-out.temp 5rcv-out.temp test-5-terminate-universe-discovery-check/src test-5-terminate-universe-discovery-check/rcv test-5-terminate-universe-discovery-check/src_expected test-5-terminate-universe-discovery-check/rcv_expected 20
...
sh test_check.sh 5-terminate-universe-discovery-check 5src-out.temp 5rcv-out.temp test-5-terminate-universe-discovery-check/src test-5-terminate-universe-discovery-check/rcv test-5-terminate-universe-discovery-check/src_expected test-5-terminate-universe-discovery-check/rcv_expected 20
