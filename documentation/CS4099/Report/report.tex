...
\section{Design}
Indicating the structure of the system, with particular focus on main ideas of the design, unusual design
features, etc.
...
\section{Implementation}
 These correspond to the 3 files within the library, "receive", "source"
...
The receiver contains both parts specified within the design, uses a mechanism based around repeated calls to recv, alternatively could have had a separate thread like on the sender but this would add complexity. 

Implementation detail
 - Event based receiver vs the current poll / timeout based system.
