...
words long, including project specification, plan and testing excluding appendices.
...
The details of how to run the various tests, demo-programs and examples are described in the "usage.pdf" file (the "usage" appendix). Installation instructions are detailed within the README file.\\
...
\includepdf[pages=-,pagecommand={},scale=1.0]{Packet-Structure.pdf}
\subsection{Synchronisation Mechanism}
\includepdf[pages=-,pagecommand={},scale=1.0]{Sync-Mechanism.pdf}
\subsection{Discovery Mechanism}
\includepdf[pages=-,pagecommand={},scale=1.0]{Discovery-Mechanism.pdf}
\subsection{ANSI E1.31-2018 Compliance Testing Check List}
\includepdf[pages=-,pagecommand={},scale=1.1]{ANSI-E1.31-2018-Compliance-Check-List.pdf}
\subsection{Usage}
\includepdf[pages=-,pagecommand={},scale=1.0]{usage.pdf}
